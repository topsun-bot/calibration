...
| [user/simulation.md](user/simulation.md) | MuJoCo 仿真、pytest、演示录制 |
...
2. [hand_eye/gap_analysis_vs_ros_tools.md](hand_eye/gap_analysis_vs_ros_tools.md) — 与 easy_handeye2 / MoveIt 差距分析
...
| 手眼求解 | `calibate/common/hand_eye_solve.py` |
...
- 项目名统一为 **calibration**（旧名 goat_demo 已废弃）
